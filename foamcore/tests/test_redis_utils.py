...
from foamcore.logger import logger
from foamcore.services import start_redis_server
from foamcore.redis_utils import (
    init_redis_connection, redis_connection, RedisConnection, RedisSubscriber,
    RedisPSubscriber, _global_connections
)
from foamcore.processes import wait_until_redis_shutdown
...
class TestRedisConnection(unittest.TestCase):
    ...
    @patch("foamcore.redis_utils.redis_connection")
