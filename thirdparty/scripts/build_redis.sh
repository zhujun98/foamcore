...
mkdir -p ${ROOT_DIR}/foamcore/thirdparty/bin
cp ${REDIS_BUILD_DIR}/src/redis-server ${ROOT_DIR}/foamcore/thirdparty/bin/redis-server
cp ${REDIS_BUILD_DIR}/src/redis-cli ${ROOT_DIR}/foamcore/thirdparty/bin/redis-cli
